...
### 高精度テクスチャのサポート
ツールは高精度入力 (16bit, Float) を自動検出し、品質を保持するために **RGBA16F形式** で出力します。

- **対応入力**: G16, R16F, R32F, RGBA32F
- **出力形式**: BGRA8 (標準) と RGBA16F (高精度) を自動切り替え
- **用途**: ハイトマップ、Signed Distance Fields (SDF)、HDRマスク
